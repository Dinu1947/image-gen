...
# st.set_page_config(page_title="Levrage AI Image Generator", layout="centered")
# st.title("🧠 Levrage AI — Prompt-to-Image Generator")

# # Initialize session state for last image path
...
# uploaded_image = st.file_uploader("Optional: Upload a reference image", type=["png", "jpg", "jpeg"])

# # Prompt input
# user_prompt = st.text_area("Enter your prompt", height=150)

# # Checkbox for using previous image
# use_last = st.checkbox("Use last generated image as reference")
...
#                 st.image(image_bytes, caption="Generated by Levrage AI", use_container_width=True)
#                 st.download_button("⬇️ Download Image", data=image_bytes, file_name="generated_image.png", mime="image/png")
#         else:
